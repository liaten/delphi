...
begin
  ...
  loginform.dbmsg.Caption:='Неудачное соединение с базой данных';
  if conn.Connected=true then
  begin
    loginform.dbmsg.Enabled:=false;
    loginform.dbmsg.Caption:='Удачное соединение с базой данных';
  end;
  sortflag:=true;
...
begin
  ...
  useridlabel.Caption:=useridlabel.Caption+'Ваша должность: '+login.username+'.';
